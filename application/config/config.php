...
|
*/
$config['encryption_key'] = 'sanskrutitech';
...
/*
|--------------------------------------------------------------------------
| Is Chikitsa already installed?
|--------------------------------------------------------------------------
|
| install = 1 means application is already installed.
| install = 0 means application is not already installed
|
*/
$config['install'] = 0;
...
|--------------------------------------------------------------------------
|
| demo = 1 means application is a Demo.
| demo = 0 means application is not a Demo.
|
*/
$config['demo'] = 0;
