...
<?php echo form_open('settings/clinic') ?>
	...
	<input type="input" name="end_time" id="end_time" value="<?=$end_time; ?>"/><br/>
        ...
        <select name="time_interval">
            <option <?php $var = 0.25; if($time_interval == $var){echo 'selected = "selected"';}  ?> value="0.25">15 Min</option>
            <option <?php $var = 0.50; if($time_interval == $var){echo 'selected = "selected"';}  ?> value="0.50">30 Min</option>
